...
Revision ID: a7145e2d3577
Revises: 69d3cedd8dc6
Create Date: 2026-07-22 15:51:54.236706
...
revision: str = 'a7145e2d3577'
down_revision: Union[str, None] = '69d3cedd8dc6'
...
def upgrade() -> None:
    ...
    op.create_index('ix_reaction_message', 'message_reactions', ['message_id'], unique=False)
